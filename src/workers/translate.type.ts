...
import type { TranslationOutput } from '@xenova/transformers';
import type { GenerationConfigType } from '@xenova/transformers/types/utils/generation';

interface TranslatorOptions extends GenerationConfigType {
  src_lang: string;
  tgt_lang: string;
}

interface TranslatorOutput extends TranslationOutput {
